  ...
  return (
    ...
    >
      <div class="fc-stage__panel fc-stage__panel--light">
        <FastCommentsCommentWidget apiRef={(h) => (handle = h)} tenantId="demo" urlId="solid-demo-simple-sso" simpleSSO={simpleSSO} hasDarkBackground={isDark()} />
      </div>
    </DemoChrome>
  );
}
